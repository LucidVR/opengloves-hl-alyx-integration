...
<div id="content" class="font-sans min-h-screen w-screen flex flex-col justify-center items-center bg-gray-50">
    <div class="flex-grow my-10 w-1/2">
        <Form />
    </div>
    <footer class="p-4 text-center flex flex-row w-full justify-center flex-grow">
        <h3 on:click={() => open('https://github.com/LucidVR/opengloves-hl-alyx-integration')}
